...
SendMsg(n) ==
  ...
  /\ \E j \in Nodes \ {n} :
          ...
          /\ Send({ << j, [type |-> "pl", q |-> 0, color |-> "black" ]>> }) \* This is a hack to make it work with Messaging.tla
